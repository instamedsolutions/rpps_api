...
final class Version20240919103509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE city ADD CONSTRAINT FK_2D5B02347FE7CB46 FOREIGN KEY (main_city_id) REFERENCES city (id)');
        $this->addSql('ALTER TABLE department ADD CONSTRAINT FK_CD1DE18A98260155 FOREIGN KEY (region_id) REFERENCES region (id)');
        $this->addSql('ALTER TABLE department ADD CONSTRAINT FK_CD1DE18AAD611528 FOREIGN KEY (chef_lieu_id) REFERENCES city (id)');
        $this->addSql('ALTER TABLE rpps ADD city_entity_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE rpps ADD CONSTRAINT FK_52B0862B25716148 FOREIGN KEY (city_entity_id) REFERENCES city (id)');

...
final class Version20240919171433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE specialty (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) NOT NULL, canonical VARCHAR(255) NOT NULL, created_date DATETIME NOT NULL, import_id VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_E066A6ECAFD2F094 (canonical), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

...
final class Version20210430234956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE diseases (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', parent_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', group_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', category_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', cim VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, hierarchy_level SMALLINT NOT NULL, sex SMALLINT DEFAULT NULL, lower_age_limit INT DEFAULT NULL, upper_age_limit INT DEFAULT NULL, created_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_F762064732EC6160 (cim), INDEX IDX_F7620647727ACA70 (parent_id), INDEX IDX_F7620647FE54D947 (group_id), INDEX IDX_F762064712469DE2 (category_id), INDEX diseases_index (cim), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE diseases_group (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', parent_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', cim VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, created_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_5B413DF032EC6160 (cim), INDEX IDX_5B413DF0727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
